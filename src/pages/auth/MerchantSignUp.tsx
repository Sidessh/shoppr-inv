...
const MerchantSignUp = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await register({ name, email, password, role: 'MERCHANT' });
      toast({
        title: 'Account created!',
        description: 'Welcome to Bharat Shops Hub. Your merchant account has been created successfully.',
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-xl border-0 bg-white/80 backdrop-blur-sm">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">Create Merchant Account</CardTitle>
          <CardDescription className="text-gray-600">
            Join Bharat Shops Hub and start selling your products
          </CardDescription>
        </CardHeader>
