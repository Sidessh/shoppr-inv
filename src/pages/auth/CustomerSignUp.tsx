  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: 'Welcome to Shoppr! Your account has been created successfully.',
      });
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <Card className="w-full max-w-md shadow-2xl border-0 bg-gradient-to-br from-orange-50/60 to-orange-100/40 backdrop-blur-sm relative border border-orange-200/50">
          ...
          <CardHeader className="space-y-1 text-center pt-12">
            ...
            <CardTitle className="text-2xl font-bold text-orange-900">Create Account</CardTitle>
            <CardDescription className="text-orange-700">
              Join Shoppr and start your shopping journey today
            </CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="firstName" className="text-sm font-medium text-orange-800">
                    First Name
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="lastName" className="text-sm font-medium text-orange-800">
                    Last Name
                  </Label>
                  <div className="relative">
                    <User className="absolute left-3 top-3 h-4 w-4 text-orange-500" />
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword" className="text-sm font-medium text-orange-800">
                  Confirm Password
                </Label>
                <div className="relative">
                  <Lock className="absolute left-3 top-3 h-4 w-4 text-orange-500" />
